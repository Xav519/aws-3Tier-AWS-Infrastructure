...
It features a a **Dockerized** stack consisting of a **React** frontend, a **Go** (Golang) REST API, and a **PostgreSQL** RDS database, all orchestrated within a custom-designed AWS VPC across multiple Availability Zones.
